...
export async function POST(req: NextRequest) {
  try {
    ...
    const prompt = 'what is the current reading give me 5 digit (remove the last so it will be 4 digit) and in qubic meter. Just give me the numbers and nothing else.';
    const imagePart = {
      inlineData: {
        data: base64Image,
        mimeType: mimeType,
